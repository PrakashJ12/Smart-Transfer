...
public class HttpFileHandler implements HttpRequestHandler {
	...
	private StringEntity createDirListHtml(File dir, String target)
		...
		sb.append(null == target ? dir.getAbsolutePath() : target);
		sb.append(" Index</h1>\n<table id=\"table\">\n");
		sb.append("<tr class=\"header\">\n<td>Name</td>\n<td class=\"detailsColumn\">Size</td>\n<td class=\"detailsColumn\">Modified</td>\n<td class=\"detailsColumn\">Processing operations</td>\n</tr>\n");
		/* Parent directory*/
		if (!isSamePath(dir.getAbsolutePath(), this.webRoot)) {
			sb.append("<tr>\n<td><a class=\"icon up\" href=\"..\">[Parent directory]</a></td>\n<td></td>\n<td></td>\n<td></td>\n</tr>\n");
		}
		/* Directory Listing */
	...
	private boolean isSamePath(String a, String b) {
		String left = a.substring(b.length(), a.length()); // beginning with a b
		if (left.length() >= 2) {
			return false;
		}
	...
	/** Sort by: folders, files, and then install each character sequence */
